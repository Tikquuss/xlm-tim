...
### 3. TRANSFORMERS WITH COMPETITIVE ENSEMBLES OF INDEPENDENT MECHANISMS ([TIM](https://arxiv.org/abs/2103.00336))
...
**Open the illustrative notebook in colab**[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Tikquuss/meta_XLM/blob/master/notebooks/tuto.ipynb)
...
Move to the `core` folder in advance.  
```
cd core
```
...
python ../split_data.py -d /content/my_data.csv -o $DATA_PATH  -v 0.2 -r 0 -t classification
```

See [classif_template.json](configs/classif_template.json) file for more details.
```
config_file=../configs/classif_template.json
python classify.py --config_file $config_file --train_data_file $DATA_PATH/my_data_train.csv  --val_data_file $DATA_PATH/my_data_val.csv
```
